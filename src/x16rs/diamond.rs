...
pub fn diamond_hash(bshash: &[u8; HASH_SIZE]) -> [u8; 16] {
...
pub fn mine_diamond(number: u32, prevblockhash: &[u8; HASH_SIZE], nonce: &[u8; 8], address: &[u8; 21], 
    custom_message: impl AsRef<[u8]>) -> ([u8; HASH_SIZE], [u8; HASH_SIZE], [u8; 16]) {
    /* hash stuff */
    let stuff =  [ 
