...
pub const MSG_REPORT_PEER: u8 = 1; // Report my port + peerid + peername, and request that you want to connect as a persistent node
pub const MSG_ANSWER_PEER: u8 = 2; // Reply to my peerid + peername and agree to use it as a persistent connection
pub const MSG_PING: u8 = 3;
pub const MSG_PONG: u8 = 4;
// Message to disconnect immediately after reply
pub const MSG_REQUEST_NODE_ID_FOR_PUBLIC_CHECK: u8 = 201;
